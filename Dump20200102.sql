...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2019-12-20 21:59:30',NULL),('diagnostics.include_raw','OFF','2019-12-20 21:59:30',NULL),('ps_thread_trx_info.max_length','65535','2019-12-20 21:59:30',NULL),('statement_performance_analyzer.limit','100','2019-12-20 21:59:30',NULL),('statement_performance_analyzer.view',NULL,'2019-12-20 21:59:30',NULL),('statement_truncate_len','64','2019-12-20 21:59:30',NULL);
...
-- Dump completed on 2020-01-02 16:38:36
-- MySQL dump 10.13  Distrib 8.0.18, for Win64 (x86_64)
--
...
INSERT INTO `brand` VALUES (1,'INDO',1),(2,'RAYBAN',1),(3,'OAKLEY',1),(4,'CARRERA',1),(5,'POLAROID',1),(6,'PERSOL',1),(7,'ARNETTE',1),(8,'BOLLÉ',1),(9,'VUARNET',1),(10,'POLICE',2);
...
CREATE TABLE `client` (
  ...
  `surname1Client` varchar(20) NOT NULL,
  `surname2Client` varchar(20) NOT NULL,
  `NIFClient` varchar(9) NOT NULL,
  `typeofroadClient` varchar(25) NOT NULL,
  `nameofroadClient` varchar(45) NOT NULL,
  `numofroadClient` int(11) DEFAULT NULL,
  `stairaddressClient` varchar(12) DEFAULT NULL,
  `flooraddressClient` varchar(12) DEFAULT NULL,
  `dooraddressClient` varchar(12) DEFAULT NULL,
  `cityClient` varchar(30) NOT NULL,
  `postalcodeClient` int(5) NOT NULL,
  `countryClient` varchar(30) NOT NULL,
  `phoneClient` varchar(12) NOT NULL,
  `emailClient` varchar(45) NOT NULL,
  `dateregClient` date NOT NULL,
  `datetermClient` date DEFAULT NULL,
  `recomClient` int(11) DEFAULT NULL,
  PRIMARY KEY (`idClient`),
  UNIQUE KEY `NIFClient_UNIQUE` (`NIFClient`),
  KEY `idClient_idx` (`recomClient`),
  CONSTRAINT `idClient` FOREIGN KEY (`recomClient`) REFERENCES `client` (`idClient`)
...
INSERT INTO `client` VALUES (1,'MANUÉ','XANXE','XANXE','78125605X','CALLE','SUSPIRO VERDE',11,NULL,'2','1','BARCELONA',8002,'ESPAÑA','645546564','MXANXE@GMAIL.COM','2019-10-12',NULL,NULL),(2,'CLARA','BOYA','ROTA','61948404C','CALLE','SUSPIRO VERDE',11,NULL,'2','1','BARCELONA',8002,'ESPAÑA','665544332','CBOYA@GMAIL.COM','2019-10-15',NULL,1),(3,'XOSE ANTÓN','PAZOS','DE VIEIRA','23547726G','CALLE','DEL PERCEBE',33,NULL,'BAJOS','2','PONTEVEDRA',36003,'ESPAÑA','654321098','XAPAZOS@GMAIL.COM','2019-10-12',NULL,NULL);
...
CREATE TABLE `detail` (
  ...
  `idGlasses` varchar(20) NOT NULL,
  `idEmployee` int(11) NOT NULL,
  `gradLglass` varchar(10) DEFAULT NULL,
  `colourLglass` varchar(15) DEFAULT NULL,
  `treatmentLglass` varchar(30) DEFAULT NULL,
  `priceLglass` decimal(6,2) DEFAULT NULL,
  `gradRglass` varchar(10) DEFAULT NULL,
  `colourRglass` varchar(15) DEFAULT NULL,
  `treatmentRglass` varchar(30) DEFAULT NULL,
  `priceRglass` decimal(6,2) DEFAULT NULL,
  PRIMARY KEY (`idDetail`),
  KEY `fk_idSale_idx` (`idSale`),
  KEY `fk_idGlasses_idx` (`idGlasses`),
  KEY `fk_idEmployee_idx` (`idEmployee`),
  CONSTRAINT `fk_idEmployee` FOREIGN KEY (`idEmployee`) REFERENCES `employee` (`idEmployee`),
  CONSTRAINT `fk_idGlasses` FOREIGN KEY (`idGlasses`) REFERENCES `glasses` (`idGlasses`),
...
INSERT INTO `detail` VALUES (3,3,'INDOPASTA2B',1,'+0.25','TRANS','ANTIREFLEX',50.00,'+0,30','TRANS','ANTIREFLEX',50.00),(4,3,'RAYBANPASTA1BM',1,'+0.25','MARRON','UV',75.00,'+0.30','MARRON','UV',75.00),(5,4,'INDOPASTA1W',3,'+1.25','TRANS','ANTIREFLEX',50.00,'+1.15','TRANS','ANTIREFLEX',50.00),(6,5,'POLICEMETAL1G',2,'-2.00','TRANS','ANTIREFLEX',50.00,'-1.75','TRANS','ANTIREFLEX',50.00);
...
INSERT INTO `employee` VALUES (1,'PAQUI DERMO'),(2,'LUIS TÉRICO'),(3,'JULEN TILLA'),(4,'JACOB TICA');
...
CREATE TABLE `glasses` (
  ...
  `typeframeGlasses` varchar(10) NOT NULL,
  `colourframeGlasses` varchar(15) NOT NULL,
  `priceGlasses` decimal(6,2) NOT NULL,
  `dateregGlasses` date NOT NULL,
  `stockGlasses` int(11) unsigned zerofill NOT NULL,
  PRIMARY KEY (`idGlasses`),
  KEY `fk_idBrand_idx` (`idBrand`),
  CONSTRAINT `fk_idBrand` FOREIGN KEY (`idBrand`) REFERENCES `brand` (`idBrand`)
...
INSERT INTO `glasses` VALUES ('INDOMETAL1G',1,'','',89.00,'2019-06-01',00000000005),('INDOMETAL1S',1,'','',89.00,'2019-06-01',00000000005),('INDOPASTA1B',1,'','',95.00,'2019-06-01',00000000004),('INDOPASTA1W',1,'','',95.00,'2019-06-01',00000000005),('INDOPASTA2B',1,'','',100.00,'2019-06-01',00000000002),('POLICEMETAL1G',10,'','',78.00,'2019-06-15',00000000002),('POLICEPASTA1R',10,'','',75.00,'2019-06-15',00000000004),('RAYBANPASTA1BG',2,'','',120.00,'2019-06-15',00000000004),('RAYBANPASTA1BM',2,'','',120.00,'2019-06-15',00000000003),('RAYBANPASTA1BV',2,'','',120.00,'2019-06-15',00000000003);
...
CREATE TABLE `provider` (
  ...
  `nameProvider` varchar(60) NOT NULL,
  `NIFProvider` varchar(9) NOT NULL,
  `typeofroadProvider` varchar(25) NOT NULL,
  `nameofroadProvider` varchar(45) NOT NULL,
  `numofroadProvider` int(11) DEFAULT NULL,
  `stairaddressProvider` varchar(12) DEFAULT NULL,
  `flooraddressProvider` varchar(12) DEFAULT NULL,
  `dooraddressProvider` varchar(12) DEFAULT NULL,
  `cityProvider` varchar(30) NOT NULL,
  `postalcodeProvider` int(5) NOT NULL,
  `countryProvider` varchar(30) NOT NULL,
  `phone1Provider` varchar(12) NOT NULL,
  `phone2Provider` varchar(12) DEFAULT NULL,
  `faxProvider` varchar(12) DEFAULT NULL,
  PRIMARY KEY (`idProvider`),
  UNIQUE KEY `NIFProvider_UNIQUE` (`NIFProvider`)
...
INSERT INTO `provider` VALUES (1,'GAFASA','E85463479','CALLE','DE LAS LENTES',123,NULL,'3','2','BARCELONA',8006,'ESPAÑA','935888990','633343536',NULL),(2,'VISIONOK','C87375820','AVENIDA','DEL PUENTE',64,NULL,'BAJOS',NULL,'BARCELONA',8020,'ESPAÑA','932455555','629562179',NULL);
...
CREATE TABLE `sale` (
  ...
  `dateregSale` date NOT NULL,
  `amountSale` decimal(6,2) NOT NULL,
  `ivaSale` decimal(6,2) GENERATED ALWAYS AS ((`amountSale` * 0.21)) STORED,
  `totalSale` decimal(6,2) GENERATED ALWAYS AS ((`amountSale` + `ivaSale`)) STORED,
  PRIMARY KEY (`idSale`),
...
INSERT INTO `sale` (`idSale`, `idClient`, `dateregSale`, `amountSale`) VALUES (3,1,'2019-10-12',470.00),(4,2,'2019-10-12',195.00),(5,3,'2019-10-15',178.00);
...
-- Dump completed on 2020-01-02 16:38:37
